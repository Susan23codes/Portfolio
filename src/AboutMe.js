    ...
    return (
        <>
            <div className="about-me-main">
                <h2 style={{ marginLeft: '3rem', fontSize: '2rem' }}>About Me</h2>
                <div style={{ fontSize: '20px', marginLeft: '3rem' }}>I am a Software Developer
                    ...
                    discipline to stick with a piece of work until I get it right.</div>
                <h2 style={{ marginLeft: '3rem', fontSize: '2rem', marginTop:'3rem' }}>Skills</h2>
